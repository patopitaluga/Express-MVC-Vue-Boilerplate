...
module.exports = {
  ...
  entry: {
    'somebundle': './src/sections/src-somebundle.js',
  ...
  resolve: {
    ...
    alias: {
      '@frontend_scripts_src': path.resolve(__dirname, 'src'),
      '@html_components': path.resolve(__dirname, 'components'),
      '@vue_components': path.resolve(__dirname, 'vue-components'),
    }
  },
  devtool: 'source-map',
